...
/**
 * Test case for class \Cerebrum\Instafeed\Domain\Model\RawPictures.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class RawPicturesTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Cerebrum\Instafeed\Domain\Model\RawPictures
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Cerebrum\Instafeed\Domain\Model\RawPictures();
	}
