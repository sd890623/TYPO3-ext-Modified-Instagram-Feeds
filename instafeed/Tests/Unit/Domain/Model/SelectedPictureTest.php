...
/**
 * Test case for class \Cerebrum\Instafeed\Domain\Model\SelectedPicture.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class SelectedPictureTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Cerebrum\Instafeed\Domain\Model\SelectedPicture
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Cerebrum\Instafeed\Domain\Model\SelectedPicture();
	}
